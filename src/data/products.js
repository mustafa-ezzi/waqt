...
export const products = [
  ...
  },
  {
    ...
    description:
      "The Two-Tone Classic is the classic two-tone hour. A silver-tone case is crowned with a fluted yellow-gold bezel; the dial is a soft silver grid, linen-textured, with ten diamond-set indices in square gold mounts and three slender gold hands. The bracelet is five-link: brushed steel at the edges, polished gold in the centre — The Two-Tone Classic rhythm. It is the piece that looks like it has always belonged on the wrist, even the first time it is worn.",
    specs: [
      ...
      { label: "Bracelet", value: "Five-link The Two-Tone Classic" },
      { label: "Strap", value: "—" },
      { label: "Size", value: "Classic round" },
      { label: "Movement note", value: "Quartz, jewelry-grade" },
    ],
